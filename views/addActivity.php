    ...
    <div class="container-fluid">
        <div class="row">
            <form id="addActivity" class="col s10" action="#" method="POST">
                ...
                <div class="input-field col s10 offset-s2">
                    <textarea id="planning" name="planning" class="materialize-textarea"><?= $activity->planning ?></textarea>
                    <label for="planning">Préparatifs de l'atelier</label>
                    <p id="error"><?= isset($formError['planning']) ? $formError['planning'] : '' ?></p>
                </div>
                <div class="input-field col s10 offset-s2">
                    <textarea id="progress" name="progress" class="materialize-textarea"><?= $activity->progress ?></textarea>
                    <label for="progress">Déroulement de l'atelier</label>
                    <p id="error"><?= isset($formError['progress']) ? $formError['progress'] : '' ?></p>
                </div>
                <div class="input-field col s10 offset-s2">
                    <textarea id="resultOfActivity" name="resultOfActivity" class="materialize-textarea"><?= $activity->resultOfActivity ?></textarea>
